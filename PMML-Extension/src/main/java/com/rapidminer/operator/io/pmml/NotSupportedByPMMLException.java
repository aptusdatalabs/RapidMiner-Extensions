...
/**
 * This exception should be thrown if something is not compatible with PMML.
...
public class NotSupportedByPMMLException extends UserError {
	...
	public NotSupportedByPMMLException(Object causingObject) {
		super(null, 949, causingObject.getClass().getSimpleName());
	}
